...
function obtenerPiloto($numeroPiloto){
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => "https://api.openf1.org/v1/drivers?driver_number=$numeroPiloto&session_key=9158",
	...
	if ($err) {
		...
		echo "<b>Foto del piloto: </b><br> <img src='" . $objeto[0]->headshot_url . "' alt='Foto del piloto';'><br><br>";
		...
		echo "<b>Clave de sesion: </b>" . $objeto[0]->session_key . "<br><br><br><br>";
	}
}
